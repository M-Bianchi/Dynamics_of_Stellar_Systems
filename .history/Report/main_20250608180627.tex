...
In this work, we will focus on the process that causes the sinking of the MBHs towards the core of the merging remnant, which is known as dynamical friction.
The main idea is that a massive object moving through a stellar system will transfer energy and angular momentum to the surrounding stars.
...
\begin{equation}\label{eq:chandrasekhar}
    \dfrac{d\vec{v}_M}{dt} \, = \, -16 \pi^2 G^2 m \left(m+M\right) \ln \Lambda \left[\int^{v_M}_0 f(v_m) v_m^2 dv_m\right] \dfrac{\vec{v}_M}{v_M^3},
\end{equation}
where $\ln \Lambda$ is the Coulomb logarithm, which depends on the maximum and minimum impact parameters of the interaction, $m$ is the mass of the background particles, and $M$ is the mass of the perturber.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
