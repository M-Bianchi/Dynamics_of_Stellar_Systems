...
For each model, we derive the radial probability distribution function (PDF) of the particles, which can be used to sample their positions, and the analogous velocity PDF
\vspace{0.5em}
...
The resulting density and velocity profiles for the three models are shown in Fig. \ref{fig:profiles}.
