...
The last step is substituting $\rho_\text{King}(r)$ in Eq. \ref{eq:ris_pdf} to obtain the radial PDF of the particles, which can be sampled using the acceptance-rejection method.
\vspace{0.5em}
