...
In general, this should be achieved by sampling from the velocity PDF of the model.
This, in turn, is obtained by integrating the distribution function $f(\mathcal{E}(r,v))$ — which defines the number of particles per unit of phase-space volume — over $dv^3$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
