...
\end{equation}
We determine the value of $\sigma$ by imposing the virial equilibrium:
...
In this case, the integrand simplifies (see Eq.~\ref{eq:velocity_pdf} and \ref{eq:sis_distribution_function}), and the integral becomes:
\begin{equation}
