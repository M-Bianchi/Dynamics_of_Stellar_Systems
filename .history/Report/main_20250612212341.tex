...
\begin{equation}
    \vec{a}_i(t) \simeq \dfrac{\vec{v}_i(t+dt) - \vec{v}_i(t)}{\Delta t_\text{output}} \:\: ,
...
Future work could focus on improving the simulation of stellar hardening by using a direct N-body algorithm to compute the interactions between the stars and the SMBHs, rather than relying on a treecode algorithm.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
