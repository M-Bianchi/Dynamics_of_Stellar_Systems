...
Our goal is to simulate the evolution of two SMBHs moving through the bulge of an elliptical galaxy. 
...
The two SMBHs are initialized on circular orbits at $R_{75\%} = 5 \text{kpc}$ from the center of mass, one at position $\vec{r}_1 (t=0) = (R_{75\%}, 0, 0)$ with velocity $\vec{v}_1 (t=0) = (0, v_0, 0)$, and the other at position $\vec{r}_2 (t=0) = (-R_{75\%}, 0, 0)$ with velocity $\vec{v}_2 (t=0) = (0, 0, v_0)$.
