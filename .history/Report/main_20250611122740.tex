...
To initialize the initial velocities, we compute the conditional PDF $p_\text{King}(v|r)$ by substituting the distribution function of Eq. \ref{eq:king_distribution_function} into Eq. \ref{eq:velocity_pdf}.
