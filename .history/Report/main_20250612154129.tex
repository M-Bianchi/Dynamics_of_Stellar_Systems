...
\end{equation}
To adapt this approximated equation to our models, we replace the density and the velocity dispersion with estimates at the position of the SMBHs, i.e., $n(r_i(t))$ and $\sigma(r_i(t))$.
In particular, we
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
