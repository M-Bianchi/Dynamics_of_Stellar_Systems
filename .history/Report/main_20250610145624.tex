...
In general, this should be done by sampling from the velocity PDF of the model, which is given by the integral of the distribution function $f(\mathcal{E})$ over $dv^3$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
