...
To achieve an accurate simulation of the system's evolution, we evolve the system from $t=0$ to $t=15 \,text{iu} \approx 2.236 \,Gyr$the Barnes-Hut treecode algorithm with the following parameters:
