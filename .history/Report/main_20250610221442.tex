...
A more appropriate regularization of the SIS distribution is represented by \cite{King1966} \textbf{models}, a class of spherically symmetric models that are characterized by a stationary central density and a cutoff at large distances, parametrized by a truncation radius $r_\text{truncation}$.
