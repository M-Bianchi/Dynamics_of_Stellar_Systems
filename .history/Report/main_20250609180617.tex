...
In any case, modeling a galactic bulge requires a large number of particles, typically of the order of $N \approx 10^6$ or more, and thus the use of direct N-body simulations — which have complexity $\mathcal{O}(N^2)$ — is not feasible.
