...
The most promising solution to this problem is stellar hardening, which is the process by which stars undergo three-body interactions with the binary, taking away energy and angular momentum.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
