...
\begin{figure}\centering
	\includegraphics[width=1.\columnwidth]{Separation.png}
    \caption{Separation of the two SMBHs (red) for the RIS model (upper panel), the King model (middle panel), and the Hernquist model (lower panel). The mean influence radiaus (green) is also shown.}
