...
Once the MBHs have sunk to the center of the merger remnant and have got close enough that the dynamics of one is dominated by the gravitational pull of the other, they will eventually form a binary system.
The scale of the critical separation can be approximated by the influence radius, which is defined as the distance at which the gravitational potential of the MBH is comparable to the kinetic energy of the surrounding stars:
\begin{equation}
