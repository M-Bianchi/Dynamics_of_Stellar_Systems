...
The idea is to cure the divergence at $r=0$ by introducing a softening radius $r_0$ (which has nothing to do with that used in the treecode) and introduce an exponential cutoff at large distances, governed by a scale length $R$.
