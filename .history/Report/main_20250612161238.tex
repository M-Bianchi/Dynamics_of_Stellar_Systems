...
In our case, we set $\ln \Lambda = 5$ to match the amplitude of the accelerations computed from the data.
The time evolution of the net acceleration of the two SMBHs is shown in the upper panel of Fig. \ref{fig:acceleration}, where we can see that the net acceleration is initially negative, indicating that the SMBHs are losing energy and angular momentum.
When the first SMBH reaches the dense core, its acceleration becomes positive, while the second SMBH continues to experience a negative acceleration until it forms a bound state with the first one.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
