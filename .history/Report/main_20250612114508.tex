...
The resulting density and velocity profiles for the three models are shown in Fig. \ref{fig:profiles}, where $r$ is the distance from the center of mass of the  system, computed neglecting the 10\% outer particles.
\vspace{0.5em}
