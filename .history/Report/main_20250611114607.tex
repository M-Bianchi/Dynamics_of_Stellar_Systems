...
Regarding the initial velocities, we can obtain their PDF by plugging the distribution function of Eq. \ref{eq:king_distribution_function} into Eq. \ref{eq:velocity_pdf}.
...
\begin{equation}
    v_\text{escape}(r)=\sqrt{-2\phi(r)}=\sqrt{2\psi(r)}=\sqrt{2W(x \times r_0) \sigma^2} \:\: .
