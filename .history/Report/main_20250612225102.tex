...
Morever, once the MBHs are bound, dynamical friction acts on the center of mass of the binary, rather than on the individual MBHs.
...
This process leads to a gradual decrease in binary separation and is commonly described by a power-law:
\begin{equation}
...
Further improvements could be achieved by incrementing the number of particles in the simulation, which would provide a more accurate representation of the stellar background and lead to a more realistic simulation of the binary hardening process.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
