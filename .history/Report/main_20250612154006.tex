...
\end{equation}
To better describe our models, we replace the density and the velocity dispersion of Eq. \ref{eq:chandrasekhar_sis} with estimates at the position of the SMBHs, i.e., $n(r_i(t))$ and $\sigma(r_i(t))$.
In particular, we
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
