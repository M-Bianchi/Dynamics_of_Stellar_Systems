...
Given $\rho_\text{RIS}(r)$, one could derive the gravitational potential $\Phi_\text{RIS}(r)$ via the Poisson equation, and then obtain the distribution function $f(E(r,v))$ by solving the Eddington equation.
