...
\end{equation}}
where $\ln \Lambda = \ln \left(b_\text{max}(b_\text{min})\right)$ is the Coulomb logarithm, $b$ is the impact parameter, $m$ is the mass of the background particles, $M$ is the mass of the perturber, and $f(v_m)$ is the distribution function of the background particles.
