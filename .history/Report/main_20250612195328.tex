...
\begin{equation}
    ...
    \label{eq:hardening}
\end{equation}
where $H$ is a dimensionless parameter typically in the range between $5$ and $20$.
However, our attempts to model this process failed to reproduce the data, since we obtained a tiny hardening coefficient $H_\text{measured} \approx 0.95$, which is significantly lower than the expected values.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
