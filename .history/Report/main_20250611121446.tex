...
The last step is plugging $\rho_\text{King}(r)$ into Eq. \ref{eq:radial_pdf} to obtain the radial PDF of the particles, which can be sampled using the acceptance-rejection method.
\vspace{0.5em}
