...
\begin{equation}
    p(v|r)dv = \dfrac{f(\mathcal{E}(r,v))}{n(r)} v^2 dv \:\: ,
    \label{eq:velocity_pdf}
\end{equation}
where $n(r)$ is the number density of particles at radius $r$ and $\mathcal{E}(r,v)$ is the distribution function of the particles per unit of phase-space volume.
