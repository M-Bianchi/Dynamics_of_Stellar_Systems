...
\end{equation}
This can be expressed in terms of dimensionless quantities by defining the dimensionless potential $\Phi \doteq \psi/\sigma^2$ and the dimensionless radius $x \doteq r/r_0$, where::
\begin{equation}
