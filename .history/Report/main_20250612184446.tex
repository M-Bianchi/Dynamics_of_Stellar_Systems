...
\begin{figure}\centering
    ...
    \caption{Time evolution of the SMBHs separation (red) for the RIS model (upper panel), the King model (middle panel), and the Hernquist model (lower panel). The mean influence radiaus (green) is also shown. The dashed lines indicate the time and the separation at which}
