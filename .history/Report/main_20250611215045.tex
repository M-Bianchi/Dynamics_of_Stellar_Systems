...
In all three case, it is possible to notice an initial readjustment of the Lagrangian radii and a second perturbation due to the SMBHs going moving from one shell to the next.
