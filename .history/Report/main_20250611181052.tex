...
The SMBHs are initialized on circular orbits at $R_{75\%}$ from the center of mass, one at position $\vec{r}_1 (t=0) = (R_{75\%}, 0, 0)$ with velocity $\vec{v}_1 (t=0) = (0, v_0, 0)$, and the other at position $\vec{r}_2 (t=0) = (-R_{75\%}, 0, 0)$ with velocity $\vec{v}_2 (t=0) = (0, 0, v_0)$.
