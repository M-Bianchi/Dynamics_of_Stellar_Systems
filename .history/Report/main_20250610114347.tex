...
Given this density profile, we can easily compute the radial probability distribution function (PDF) of the particles, which is given by:
\begin{equation}
    p_\text{RIS}(r) = \dfrac{4\pi r^2 \rho(r)}{M_\text{tot}} \, \propto \, \dfrac{r^2 e^{-r/R}}{\left(r + r_0\right)^2} \:\: .
    \label{eq:ris_density}
\end{equation}
