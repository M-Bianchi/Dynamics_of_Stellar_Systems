...
The critical separation can be approximated by the influence radius, which is the distance at which the gravitational potential of the MBH is comparable to the kinetic energy of the surrounding stars:
\begin{equation}
