...
\begin{figure}\centering
	\includegraphics[width=0.9\columnwidth]{Profiles.png}
...
\begin{figure}\centering
	\includegraphics[width=0.8\columnwidth]{LR_50K_dt0005_titles.png}
...
We can observe this effect in the trajectories of the two SMBHs shown in Fig. \ref{fig:Lagrangian_radii}: while the rest of the distribution remains approximately stationary, the two SMBHs sink towards the center of mass of the system, crossing a radial distance of $5 \,\text{kpc}$ in approximately $\Delta t \approx 1 \,\text{Gyr}$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
