...
\begin{equation}
    \rho(\psi) \, = \, \rho_1 \left[ e^{\psi/\sigma^2} \text{erf}\left(\dfrac{\sqrt{\psi}}{\sigma}\right) - \sqrt{\dfrac{4 \psi}{\pi \sigma^2}} \left(1+\dfrac{2 \psi}{3 \sigma^2}\right) \right] \, = \, \rho_1 \hat{\rho}(\psi) \:, \:$ where $\hat{\rho}(\psi) \:\: .
