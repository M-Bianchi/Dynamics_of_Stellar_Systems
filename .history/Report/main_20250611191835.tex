...
This implies setting the scale length $R$ of the RIS model to $R = 3.7 \text{kpc}$ ($r_0 = 1 \text{pc}$), the core radius $r_0$ of the King model to $r_0 = 155 \text{pc}$, and the scale length $a$ of the Hernquist model to $a = 800 \text{pc}$.
