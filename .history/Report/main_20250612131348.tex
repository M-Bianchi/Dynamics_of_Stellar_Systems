...
The theoretical dynamical friction acceleration is given by Eq. \ref{eq:chandrasekhar}, which includes an integral over the distribution function of the background particles.
...
This implies that the distribution function is not constant, and therefore the integral in Eq. \ref{eq:chandrasekhar} must be computed at each time-step.
