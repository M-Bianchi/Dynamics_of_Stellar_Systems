...
The efficiency of dynamical friction depends on the density and velocity distribution of the stars which constitute the bulge ofthe merger remnant.
...
The model most commonly used in analytical calculations is the \textbf{singular isothermal sphere} (SIS), which has a density profile given by:
\begin{equation}
    \rho(r) = \dfrac{\sigma^2}{2 \pi G r^2}.
