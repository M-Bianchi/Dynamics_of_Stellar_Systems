...
\begin{figure}\centering
    ...
    \caption{Mass density (red) and median velocity (blue) as a function of the distance from the center of mass of the system, at the initial time $t=0$, for the RIS model (upper panel), the King model (middle panel), and the Hernquist model (lower panel). The density errorbars have been computed by assuming Poissonian fluctuations on the number of particles in each spherical shell, while the velocity errorsbars are proportional to interquartile range.}
    \label{fig:profiles}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
