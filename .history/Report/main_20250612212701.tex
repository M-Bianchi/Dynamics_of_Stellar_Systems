...
Future work could focus on improving the simulation of stellar hardening by modifying Barnes-Hut treecode to compute the interactions between the stars and the SMBHs using a direct N-body algorithm, rather than relying on a treecode algorithm.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
