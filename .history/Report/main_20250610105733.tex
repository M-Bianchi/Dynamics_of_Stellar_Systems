...
As we introduced in the previous section, the SIS model is not physical, as it diverges at $r=0$ and has an infinite total mass.
Therefore, a realistic density profile must have a finite central value and decrease faster than $r^{-2}$ at large distances.
In this section, we will introduce three more realistic models that are commonly used to describe the density distribution of galactic bulges.
