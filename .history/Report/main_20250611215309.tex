...
Our goal is to simulate the evolution of two supermassive black holes (SMBHs) drifting through the bulge of an elliptical galaxy. 
...
In all three case, it is possible to notice an initial readjustment of the Lagrangian radii — caused by the granularity of the distribution — followed by a second perturbation due to the SMBHs moving from one shell to the next.
