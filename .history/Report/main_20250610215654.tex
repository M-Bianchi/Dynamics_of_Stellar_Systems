...
\end{equation}
This can be expressed in terms of dimensionless quantities by defining the dimensionless potential $\Phi \doteq \psi/\sigma^2$ and the dimensionless radius:
\begin{equation}
    x \doteq \dfrac{r}{r_0} \:\:,\: \text{where} \:\: r_0 = \sqrt{\dfrac{9 \sigma^2}{4 \pi G \rho_0}} \:\: \text{and} \:\: \rho_0 \:\: \text{is the central density}.
    \label{eq:king_dimensionless_radius}
\end{equation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
