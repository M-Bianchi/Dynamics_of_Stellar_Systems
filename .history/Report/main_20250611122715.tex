...
To initialize the initial velocities, we can obtain their PDF $p_\text{King}(v|r)$  by plugging the distribution function of Eq. \ref{eq:king_distribution_function} into Eq. \ref{eq:velocity_pdf}.
